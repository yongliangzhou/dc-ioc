...
CATEGORY_META: dict[str, tuple[str, str, str]] = {
    ...
    "humidifier": ("恒湿一体机", "hvac_terminal", "snmp"),
    "leak_detector": ("定位式漏水检测", "hvac_terminal", "snmp"),
    "compressor": ("压缩机", "hvac_terminal", "modbus"),
    "condenser": ("冷凝器", "hvac_terminal", "modbus"),
    "expansion_valve": ("膨胀阀", "hvac_terminal", "modbus"),
    "evaporator": ("蒸发器", "hvac_terminal", "modbus"),
    "hv_incomer": ("中压进线柜", "power_hv", "modbus"),
    "hv_feeder": ("中压馈线柜", "power_hv", "modbus"),
    "bus_tie": ("母联柜", "power_hv", "modbus"),
    "hv_isolation": ("高压隔离柜", "power_hv", "modbus"),
    "hv_breaker": ("高压断路器柜", "power_hv", "modbus"),
    "hv_metering": ("高压计量柜", "power_hv", "modbus"),
    "hv_pt": ("高压PT柜", "power_hv", "modbus"),
    "transformer": ("变压器", "power_lv", "modbus"),
    "ups": ("UPS 电源", "power_lv", "snmp"),
    "hvdc": ("高压直流", "power_lv", "modbus"),
    "ats": ("ATS 双电源", "power_lv", "modbus"),
    "lv_compensation": ("低压补偿柜", "power_lv", "modbus"),
    "lv_tie": ("低压联络柜", "power_lv", "modbus"),
    "mcc": ("MCC柜", "power_lv", "modbus"),
    "genset": ("柴油发电机", "power_genset", "modbus"),
    "gen_controller": ("柴发并机控制器", "power_genset", "modbus"),
    "fuel_tank": ("主油箱", "power_fuel", "modbus"),
    "day_tank": ("日用油箱", "power_fuel", "modbus"),
    "fuel_pump": ("供油泵", "power_fuel", "modbus"),
    "emergency_valve": ("紧急切断阀", "power_fuel", "modbus"),
    "fuel_sensor": ("燃油传感器", "power_fuel", "modbus"),
    "battery_group": ("电池组", "power_battery", "snmp"),
    "battery_convergence": ("电池收敛模块", "power_battery", "snmp"),
    ...
    "gas_detector": ("气体探测器", "security_fire", "modbus"),
    "io_substation": ("IO子站", "bms", "modbus"),
    "gc_controller": ("群控控制器", "bms", "modbus"),
    "bas_gateway": ("BAS网关", "bms", "modbus"),
}
...
METRIC_LABELS: dict[str, str] = {
    ...
    "zone": "区域编号",
    # ---- 10KV / 0.4KV 配电补充 ----
    "line_voltage_ab": "AB线电压",
    "line_voltage_bc": "BC线电压",
    "line_voltage_ca": "CA线电压",
    "phase_current_a": "A相电流",
    "phase_current_b": "B相电流",
    "phase_current_c": "C相电流",
    "breaker_state": "断路器状态",
    "switch_position": "开关位置",
    "protect_action": "保护动作信号",
    "pt_voltage": "PT电压",
    "harmonic_thd": "谐波总畸变率",
    "compensation_power": "补偿功率",
    # ---- 柴发并机补充 ----
    "parallel_mode": "并机模式",
    "engine_rpm": "发动机转速",
    "gen_frequency": "发电频率",
    "sync_status": "同期状态",
    "output_breaker": "输出断路器",
    "emergency_stop": "紧急停机",
    "coolant_temp": "冷却液温度",
    "lube_oil_pressure": "机油压力",
    # ---- 燃油系统补充 ----
    "high_level_alarm": "高液位报警",
    "low_level_alarm": "低液位报警",
    "leak_sensor": "泄漏传感器",
    "valve_open": "阀门开启",
    "valve_close": "阀门关闭",
    "flow_total": "累计流量",
