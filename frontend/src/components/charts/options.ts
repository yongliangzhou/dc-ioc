...
const DARK: ChartVars = {
  ...
  axisLine: '#1d2f4f',
  axisLabel: '#7e93b8',
  splitLine: 'rgba(29,47,79,.6)',
  legendTxt: '#7e93b8',
  tooltipBg: 'rgba(15,27,51,.95)',
  tooltipBorder: '#1d2f4f',
  tooltipTxt: '#cfe0ff',
  track: '#13233f',
  strong: '#fff',
  pieBorder: '#0a1220',
...
const LIGHT: ChartVars = {
  ...
  axisLine: '#d4deec',
  axisLabel: '#5a6c88',
  splitLine: 'rgba(212,222,236,.8)',
  legendTxt: '#5a6c88',
  tooltipBg: 'rgba(255,255,255,.97)',
  tooltipBorder: '#d4deec',
  tooltipTxt: '#1e2a3c',
  track: '#dbe4f0',
  strong: '#0b1524',
  pieBorder: '#ffffff',
...
function baseParts() {
  ...
  return {
    ...
    legend: {
      textStyle: { color: v.legendTxt, fontSize: 11 },
      itemWidth: 12,
      itemHeight: 8,
      top: 0,
    },
