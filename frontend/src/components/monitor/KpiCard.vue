<template>
  <div
    class="kpi-card card"
    :class="[sizeClass, { 'kpi-clickable': clickable }]"
  ...
  >
    <div class="ct">
      ...
      <span v-if="target !== undefined && targetLabel" class="ct-target"
...
const barColor = computed(
  () => props.barColor ?? props.progressColor ?? 'linear-gradient(90deg, var(--cyan), var(--blue))',
)
