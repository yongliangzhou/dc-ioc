    ...
    <div v-if="editing" class="drawer-mask" @click.self="editing = false">
      <div class="drawer">
        ...
        <div class="form">
          ...
          <div class="row">
            <label
              >{{ tl('预警下限') }}<input v-model.number="form.warnLo" class="ipt" type="number"
            /></label>
            <label
              >{{ tl('预警上限') }}<input v-model.number="form.warnHi" class="ipt" type="number"
            /></label>
          </div>
          <div class="row">
            <label
              >{{ tl('严重下限') }}<input v-model.number="form.critLo" class="ipt" type="number"
            /></label>
            <label
              >{{ tl('严重上限') }}<input v-model.number="form.critHi" class="ipt" type="number"
            /></label>
          </div>
          <label>
            {{ tl('单位') }}
          ...
          <label class="chk"
            ><input type="checkbox" v-model="form.enabled" /> {{ tl('启用该规则') }}</label
          >
